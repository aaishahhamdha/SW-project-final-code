            ...
            <div className="profile-card" style={coverImageStyle}>
              ...
              <div className="card-bottom">
                ...
                <div className="bottom-buttons">
                  <Link to="/dashboard">
                    <button className="save-button10" >
                    &nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Dashboard
                    </button>
                  </Link>
                </div>
                ...
                <div className="details-section">
                  ...
                  <div className="First-name card">
                    ...
                    {isEditing ? (
                      ...
                      <span className="data1">{first_Name?first_Name:"-"}</span>
                    )}
                  </div>
                  <div className="Last-Name card">
                    ...
                    {isEditing ? (
                      ...
                      <span className="data1">{last_Name?last_Name:"-"}</span>
                    )}
                  </div>
                  <div className="Email card">
                    ...
                    {isEditing ? (
                      ...
                      <span className="data1">{email?email:"-"}</span>
                    )}
                  </div>
                  <div className="Bio card">
                    ...
                    {isEditing ? (
                      ...
                      <span className="data1">{bio?bio:"-"}</span>
                    )}
                  </div>
                  <div className="Username card">
                    ...
                    {isEditing ? (
                      ...
                      <span className="data1">@{userName?userName:"-"}</span>
                    )}
                  </div>
                  <div className="Gender card">
                    ...
                    {isEditing ? (
                      ...
                      <span className="data1">{gender?gender:"-"}</span>
                    )}
                  </div>
                  <div className="Location card">
                    ...
                    {isEditing ? (
                      ...
                      <span className="data1">{location?location:"-"}</span>
                    )}
                  </div>
                  {isEditing && (
                    <div className="buttons">
                      <button className="save-button40" type="submit">
                        Update
                      </button>
                      <button className="save-button40" type="button" onClick={handleCancel}>
                        Cancel
                      </button>
                    </div>
                  )}
