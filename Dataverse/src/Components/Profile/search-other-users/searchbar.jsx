...
const Searchbar = () => {
  ...
  return (
    <div className="searchcontainer10">
        {toastMessage && (
            <Toast message={toastMessage} type={toastType} onClose={() => setToastMessage("")} />
          )}
      <input
        type="text"
        className="searchInput10"
        placeholder="Search..."
        value={searchValue}
        onChange={handleInputChange}
      />
      <button className="searchButton10" onClick={handleSearch} disabled={loading || searchValue==""}>
        <img
          src="https://img.icons8.com/ios-filled/50/000000/search.png"
          alt="search"
          className="searchIcon10"
        />
      </button>
